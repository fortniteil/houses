...
function Calendar({ className, showOutsideDays = true, showYearSwitcher = true, yearRange = 12, numberOfMonths, ...props }: CalendarProps) {
    ...
    const _monthCaptionClassName = cn('relative flex w-full flex-col items-center justify-center gap-2 pt-1', props.monthCaptionClassName);
    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                dropdown: 'w-full p-2 bg-white rounded-md z-10 space-y-2 border border-gray-200 text-sm',
